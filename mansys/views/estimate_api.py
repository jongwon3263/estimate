...
from mansys.models import ServiceOption

bp = Blueprint('price_api', __name__, url_prefix='/api')
...
def get_price():
    ...
    return jsonify(success=True, price=option.price, category_code=option.category_code)